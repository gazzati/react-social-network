...
## Разработка      
  ...
  -Новостная лента составленна на основе данных с API(https://newsapi.org/docs/endpoints/top-headlines)
...
## Функционал
  ...
  -На странице News расолагаются новости с возможностью перехода на источник. Страница также оснащена пагинатором для просмотра и загрузки новостей порциями.
